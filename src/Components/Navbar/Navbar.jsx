    ...
    <>
      ...
      <nav className="fixed w-full top-0 z-50 p-4 md:p-5 flex justify-between items-center bg-gray-800 shadow-lg">
        <div className="flex items-center">
          <img
            ...
            className="h-10 md:h-12 w-auto mr-3 md:mr-4"
          />
      ...
      >
        ...
        <div className="flex justify-end p-4">
          <button className="text-2xl text-white" onClick={closeMenu}>
            <FaTimes />
          </button>
        </div>
        ...
        <ul className="flex flex-col items-center space-y-6 p-6">
          <li><a href="#home" className="hover:text-blue-400 text-lg" onClick={closeMenu}>HOME</a></li>
          <li><a href="#about" className="hover:text-blue-400 text-lg" onClick={closeMenu}>ABOUT</a></li>
          <li><a href="#services" className="hover:text-blue-400 text-lg" onClick={closeMenu}>SERVICES</a></li>
          <li><a href="#why-us" className="hover:text-blue-400 text-lg" onClick={closeMenu}>WHY US</a></li>
          <li><a href="#clients" className="hover:text-blue-400 text-lg" onClick={closeMenu}>CLIENTS</a></li>
          <li><a href="#reviews" className="hover:text-blue-400 text-lg" onClick={closeMenu}>REVIEWS</a></li>
          <li>
            <button className="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600" onClick={closeMenu}>
              Request A Quote
            </button>
          </li>
        </ul>
        ...
        <div className="absolute bottom-6 left-0 w-full flex justify-center space-x-6">
          ...
          <a href="https://wa.me/yourwhatsapplink" target="_blank" rel="noopener noreferrer" className="text-white text-2xl hover:text-green-400">
            <FaWhatsapp />
          </a>
          <a href="https://www.messenger.com" target="_blank" rel="noopener noreferrer" className="text-white text-2xl hover:text-blue-500">
            <FaFacebookMessenger />
          </a>
        </div>
      </div>
